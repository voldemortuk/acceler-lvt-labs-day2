...
- Critical: All database queries must be written in the ./src/queries dir. This is enforced by a hook, not just convention — a scope-guard hook lands next in this same milestone.
